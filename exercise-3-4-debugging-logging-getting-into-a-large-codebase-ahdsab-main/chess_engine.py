...
class game_state:
    ...
    def __init__(self):
        ...
        self.white_Knights_moves = 0
        self.black_Knights_moves = 0
    ...
    def checkmate_stalemate_checker(self):
        ...
        all_white_moves_1 = [i[1] for i in all_white_moves]
        all_black_moves_1 = [i[1] for i in all_black_moves]
        white_king = self.get_valid_moves(self._white_king_location)
        black_king = self.get_valid_moves(self._black_king_location)


        if self._is_check and self.whose_turn() and not all_white_moves:
            print("white lost")
            logging.info("black win")
            logging.info("White Knights moves: " + str(self.white_Knights_moves))
            logging.info("Black Knights moves: " + str(self.black_Knights_moves))
            return 0
            ...
            logging.info("Black Knights moves: " + str(self.black_Knights_moves))
            return 2
        elif all_white_moves_1 == white_king and all_black_moves_1 == black_king:
            logging.info("Stalemate")
            logging.info("White Knights moves: " + str(self.white_Knights_moves))
            logging.info("Black Knights moves: " + str(self.black_Knights_moves))
            return 2
                ...
                # Add move class here
                    ...
                    if moving_piece.get_name() == "n":
                        if moving_piece.get_player() == Player.PLAYER_1:
                            self.white_Knights_moves += 1
                        else:
                            self.black_Knights_moves += 1
                    self.can_en_passant_bool = False
